...
use VuFind\Search\Factory\BlenderBackendFactory as OriginalBlenderBackendFactory;
use ThULBSearch\Backend\Blender\Backend;
 ...
 * @link     http://vufind.org   Main Site
 */
class BlenderBackendFactory extends OriginalBlenderBackendFactory
{
    /**
     * Create service
     *
     ...
     * @param array|null         $options Extra options (unused)
     *
     * @return Backend
     *
